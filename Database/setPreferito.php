<?php
    ...
    $mode = $_GET["mode"];
    if($mode == "add")
    	$q = "INSERT INTO valtAdv_preferiti (idRistorante, idUtente) VALUES ($idRistorante, $idUtente);";
    else if($mode == "remove")
    	$q = "DELETE FROM valtAdv_preferiti WHERE (idRistorante, idUtente) = ($idRistorante, $idUtente);";
